        ...
        if (result.length == 0) {
            ...
            return (
                <>
                    ...
                    <div>
                        {
                            (result[0].locandina != undefined && result[0].locandina != "" && result[0].locandina != null) && <Zoom src={"/" + result[0].locandina} layout={"fixed"} width={200} height={200} backgroundColor={"#252525"} />
                        }
                    </div>
